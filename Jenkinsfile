    ...
    stages {
      stage('CI Build and push snapshpt') {
        ...
        steps {
          ...
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http22') {
            checkout scm
            container('go') {
              sh "make preview"
          ...
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http22/charts/preview') {
           container('go') {
             sh "make linux"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http22/charts/golang-http22') {
